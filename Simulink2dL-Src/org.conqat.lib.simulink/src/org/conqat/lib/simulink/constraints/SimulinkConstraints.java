...
public class SimulinkConstraints {
	...
	public static void addMandatoryConstraints(ConstraintValidator validator) {
		validator.addConstraint(SimulinkElementBase.class, new SimulinkElementNameConstraint());
		validator.addConstraint(SimulinkBlock.class, new SimulinkBlockTypeConstraint());
	}

	/** Add optional constraints to validator. */
	public static void addOptionalConstraints(ConstraintValidator validator) {
		validator.addConstraint(SimulinkLine.class, new SimulinkLineConstraint());
	}
