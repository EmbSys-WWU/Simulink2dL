...
public class SerializedProxyClass extends SerializedClassBase {
	...
	/** Constructor. */
	public SerializedProxyClass(DataInputStream din, SerializedEntityPool pool, SerializedEntityParser parser)
			throws IOException {
	...
	public String toString() {
		return "Proxy class for " + StringUtils.concat(proxyInterfaceNames, "|");
	}
}
