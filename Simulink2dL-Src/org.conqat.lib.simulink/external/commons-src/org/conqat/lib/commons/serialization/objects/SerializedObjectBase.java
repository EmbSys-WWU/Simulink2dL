...
public abstract class SerializedObjectBase extends SerializedEntityBase {
	...
	public List<SerializedClass> getPlainClassHierarchy() throws IOException {
		...
		while (currentClassHandle != SerializedEntityPool.NULL_HANDLE) {
			SerializedClassBase classEntity = pool.getEntity(currentClassHandle, SerializedClassBase.class);
	...
	protected void serializeContent(DataOutputStream dos, SerializedEntitySerializer serializer) throws IOException {
		...
		pool.getEntity(classHandle, SerializedClassBase.class).serialize(dos, serializer);
	...
	protected abstract void serializeObjectContent(DataOutputStream dos, SerializedEntitySerializer serializer)
			throws IOException;
}
