...
public class RatingUtils {
	 ...
	 * found at all, the file is rated RED.
	 */
	public static ETrafficLightColor calculateRating(String content, IRatingTableFileAccessor accessor) {
		...
		try {
			PartitionedRating partitionedRating = new PartitionedRating(content, accessor);
