...
public class AndPredicate<T> implements Predicate<T> {
	...
	/** Constructor. */
	@SafeVarargs
	public AndPredicate(Predicate<T>... innerPredicates) {
	...
	/**
	 * Factory method for creating an and-predicate. This is used to exploit generic
	 * type inference (i.e. syntactic reasons).
	 */
	@SafeVarargs
	public static <T> AndPredicate<T> create(Predicate<T>... innerPredicates) {
