...
public class PerformanceMonitor {
	 ...
	 * state NOT_RUN. (i.e., after it has been created via the constructor).
	 * Node: the create() method creates <b>and</b> starts the monitor.
	 * <p>
	...
	/**
	 * Returns whether the PerformanceMonitor is stopped and will return
	 * meaningful values.
	 */
	public boolean isStopped() {
		return state == EPerformanceMonitorState.FINISHED;
	}
	...
	/**
	 * Gets the measured time in milliseconds. If measuring is not stopped,
	 * returns the time since start of the measuring.
	 */
