...
public class FileExtensions {
	...
	public static final String ECUEXTRACT = ".ecuextract";

	/** Extension for AUTOSAR ECU extract variant files. */
	public static final String ECUEXTRACT_VARIANT = ".ecuextract.variant";

	/** Extension for AUTOSAR configuration XML files. */
	public static final String ARXML = ".arxml";

	/** Extension for AUTOSAR ECU configuration files. */
	public static final String ECUCONFIG = ".ecuconfig";
