...
public final class Region extends SimpleRegion {
	...
	/**
	 * Origin of the region. Can be used to store information about who created the
	 * region.
	 */
	private final String origin;

	/**
	 * Creates a region with an origin. An empty region can be denoted with and end
	 * position smaller than start.
	 * 
	 * @param start
	 *            Inclusive start position of the region
	 * @param end
	 *            Inclusive end position of the region
	 * @param origin
