...
public class SparseVector {
	...
	/**
	 * Sets the given value under the given key, value must not be <code>null</code>
	 */
	...
	public double cosineSimilarity(SparseVector other) {
		...
		Collection<Integer> commonPositions = CollectionUtils.intersectionSet(data.keySet(), other.data.keySet());
