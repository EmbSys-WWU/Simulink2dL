...
public class CloneUtils {
	 ...
	 */
	public static void cloneMapEntries(Map<String, Object> source, Map<String, Object> target)
	...
	private static <T> T createNewInstance(T object) throws DeepCloneException {
		...
		try {
			...
			throw new DeepCloneException("Could not duplicate object of type " + object.getClass(), e);
		}
	}
}
