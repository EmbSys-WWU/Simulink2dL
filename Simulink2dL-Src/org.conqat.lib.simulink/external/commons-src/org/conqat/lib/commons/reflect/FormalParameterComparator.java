...
public class FormalParameterComparator implements Comparator<FormalParameter> {
	 ...
	 */
	@Override
	public int compare(FormalParameter p1, FormalParameter p2) throws IllegalArgumentException {
		if (!p1.getMethod().equals(p2.getMethod())) {
			throw new IllegalArgumentException("Parameters must belong to same method");
		}
