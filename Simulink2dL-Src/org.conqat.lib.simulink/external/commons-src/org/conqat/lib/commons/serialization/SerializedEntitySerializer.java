...
public class SerializedEntitySerializer {
	...
	public void serializeStringObject(String value) throws IOException {
		serializeStringObject(value, true);
	}
	 ...
	 */
	public void serializeAnnotationList(List<Object> rawDataList, SerializedEntityPool pool)
			throws IOException, SerializationConsistencyException {
		for (Object rawData : rawDataList) {
			if (rawData instanceof byte[]) {
				...
				serializeObject(handle, SerializedObjectBase.class, pool, dos, this);
			} else {
	 ...
	 * handle.
	 */
	public static void serializeObject(int handle, Class<? extends SerializedEntityBase> expectedType,
			SerializedEntityPool pool, DataOutputStream dos, SerializedEntitySerializer serializer) throws IOException {
