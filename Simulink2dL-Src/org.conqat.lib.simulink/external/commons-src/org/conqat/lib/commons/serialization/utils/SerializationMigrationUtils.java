...
public class SerializationMigrationUtils {
	...
	public static void transformStringsInHashSet(SerializedObject setObject, IStringTransformation transformation,
	...
	public static <T extends SerializedEntityBase> List<T> getObjectsFromArrayList(SerializedObject setObject,
			SerializedEntityPool pool) throws IOException {

		SerializedClass setClass = findClassInHierarchy(setObject, ArrayList.class);
