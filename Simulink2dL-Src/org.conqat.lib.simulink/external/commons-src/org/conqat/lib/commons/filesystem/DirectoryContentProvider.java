 ...
 */
/* package */final class DirectoryContentProvider extends PathBasedContentProviderBase {
	...
	public DirectoryContentProvider(File baseDir) {
		CCSMAssert.isTrue(baseDir.isDirectory(), "Input file must be a directory!");
	...
	public Collection<String> getPaths() {
		...
		for (File file : FileSystemUtils.listFilesRecursively(baseDir)) {
			if (file.isFile()) {
				String relative = StringUtils.stripPrefix(file.getPath(), baseDir.getPath());
