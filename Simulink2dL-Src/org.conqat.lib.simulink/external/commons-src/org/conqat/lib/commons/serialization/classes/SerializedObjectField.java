...
public class SerializedObjectField extends SerializedComplexFieldBase {
	...
	/** Constructor. */
	public SerializedObjectField(String fieldName, SerializedEntityParser parser) throws IOException {
	 ...
	 * "Ljava/lang/String;".
	 */
	public static String createJvmNotationFromPlainClassName(String fullyQualifiedType) {
