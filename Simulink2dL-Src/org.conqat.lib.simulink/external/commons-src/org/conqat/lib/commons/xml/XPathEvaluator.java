...
public class XPathEvaluator {
	 ...
	 */
	public Object selectUnsafe(String expr, Element context, QName returnType) throws XPathExpressionException {
	...
	public int selectInt(String expr, Element context) {
		return ((Double) select(expr, context, XPathConstants.NUMBER)).intValue();
	}
