...
public class Range implements Comparable<Range>, Serializable {
	...
	public boolean contains(Range other) {
		boolean sameLowerBound = this.isLowerInclusive() == other.isLowerInclusive()
				&& this.getLower() == other.getLower();
		boolean containsLower = this.contains(other.getLower()) || sameLowerBound;
		boolean sameUpperBound = this.isUpperInclusive() == other.isUpperInclusive()
	...
	/**
	 * Calculates the union of this range with another range. The union is
	 * defined by the smaller lower bound and the higher upper bound of the two
	 * ranges.
	 */
