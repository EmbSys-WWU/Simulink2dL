...
public abstract class SerializedFieldBase {
	...
	public abstract Object readValue(DataInputStream din, SerializedEntityParser parser) throws IOException;

	/**
	 * Writes the given field value to the output stream using the correct
	 * format for this field.
	 */
	public abstract void writeValue(Object value, SerializedEntityPool pool, DataOutputStream dos,
