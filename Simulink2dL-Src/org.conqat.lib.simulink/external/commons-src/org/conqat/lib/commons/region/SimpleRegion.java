...
public class SimpleRegion implements Comparable<SimpleRegion>, Serializable {
	...
	/**
	 * Compares {@link SimpleRegion}s first by their start and then by their
	 * end.
	 */
	public static final Comparator<SimpleRegion> START_AND_END_COMPARATOR = Comparator.comparing(SimpleRegion::getStart)
