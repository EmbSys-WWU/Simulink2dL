...
public class DiagnosticUtils {
	...
	public static String getMemoryStatusDescription() {
		...
		status.append("  Max: " + StringUtils.format(runtime.maxMemory() / 1024));
		status.append("  Used: " + StringUtils.format(runtime.totalMemory() / 1024));
		status.append("  Free: " + StringUtils.format((runtime.maxMemory() - runtime.totalMemory()) / 1024));
