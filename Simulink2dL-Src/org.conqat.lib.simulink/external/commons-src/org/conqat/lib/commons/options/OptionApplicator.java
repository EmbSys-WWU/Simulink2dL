...
/* package */class OptionApplicator {
	 ...
	 *            whether this applicator is based on a "greedy" annotation.
	 */
	/* package */ OptionApplicator(Object optionHandler, Method method, boolean greedy) {
		if (method.getParameterTypes().length > 1) {
			throw new IllegalArgumentException(
					"Method " + method.getName() + " has more than 1 parameter and thus cannot be used as an option!");
		}
	...
	public void applyOption() throws OptionException {
		...
		try {
			...
			throw new IllegalStateException("Unexpectedly could not invoke given method " + method + "!", e);
	 ...
	 *             if the parameter could not be transformed to the required type.
	 */
	public void applyOption(String parameter) throws TypeConversionException, OptionException {
		...
		Object methodParameter = ReflectionUtils.convertString(parameter, method.getParameterTypes()[0]);
		try {
