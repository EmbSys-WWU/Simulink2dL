...
public class AntPatternDirectoryScanner {
	...
	/**
	 * Extract the plain prefix, i.e. the prefix of the pattern without wildcard
	 * characters or directory separators; this prefix can be used to speed up
	 * scanning, as only directories starting with one of the prefixes are
	 * relevant at all.
	 */
